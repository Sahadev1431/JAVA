//A fixeda-size queue ciass for characters
class FixedQueue implements ICharQ {
	private char q[]; // this array holds the queue
	private int putloc, getloc; // the put and get indices

	// Construct an enpty queue given its size.
...
class CircularQueue implements ICharQ {
	private char q[]; // this array holds the queue
	private int putloc, getloc; // the put and get indice
...
class IQDemo {
	...
	// Put more characters into circular ieue.
		for(i=10; i < 20; i++)
			iQ.put((char) ('A' + i));
